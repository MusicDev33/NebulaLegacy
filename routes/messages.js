...
router.post('/getmsgswithidtoken', VerifyHeaderToken, (req, res, next) => {
  var simpleArray = [];
...
router.post('/getroutes', (req, res, next) => {
  res.json({success: true, routes: ["send", "getmsgs", "getmsgswithid", "getonemsg", "getlastmsg", "deletemsg", "deletemsgs"]});
});
